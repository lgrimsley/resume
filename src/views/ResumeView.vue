...
<template>
    <main class="flex justify-center items-top md:p-8 min-h-screen w-screen overflow-x-hidden" :class="{'dark bg-zinc-900 text-white': useAppStore().getDarkMode, 'bg-white': !useAppStore().getDarkMode}">
        <div class="grid gap-4 lg:grid-cols-3 xl:w-4/5 w-screen relative">
            <!-- left col -->
            ...
            <!-- right col -->
            <div class="space-y-5 lg:col-span-2 px-7 md:pr-4 md:pl-7 w-screen md:w-full">
                <Toolbar />
